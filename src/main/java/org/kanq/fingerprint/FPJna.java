...
public class FPJna {
    ...
    public static final int FP_IMAGE_HEIGHT   	=    	(360); // 图像高度
    ...
    public void LoadLibrary() {
        ...
        {
            System.out.println("LoadLibrary lib/FPModule_SDK");
            mJna = (Jna) Native.loadLibrary(new File("lib"+File.separator+"FPModule_SDK").getAbsolutePath(), Jna.class);
        }
        else
        {
            System.out.println("LoadLibrary lib/FPModule_SDK_x64");
            mJna = (Jna) Native.loadLibrary(new File("lib"+File.separator+"FPModule_SDK_x64").getAbsolutePath(), Jna.class);
